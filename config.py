...
OWNER_ID = int(getenv("OWNER_ID", 6510235517))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Hussnain008/BrandrdXMusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/iamsilenttt")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/iamsilentt")
